(() => {
    ...
    (() => {
        ...
        //========================================================================================================================================================
        const adminBurger = document.querySelector('.header-admin__burger');
        const adminSidebar = document.querySelector('.admin-aside');

        if (adminBurger && adminSidebar) {
            const adminSidebarBody = document.querySelector('.admin-aside__inner');
            const adminSidebarClose = document.querySelector('.admin-aside__close');

            adminBurger.addEventListener('click', function () {
                adminSidebar.classList.add('_show');
                bodyLock()
            });

            adminSidebarClose.addEventListener('click', function () {
                adminSidebar.classList.remove('_show');
                bodyUnlock()
            });

            document.addEventListener('click', function (event) {
                const isClickInside = adminSidebarBody.contains(event.target) || adminBurger.contains(event.target);
        ...
        //========================================================================================================================================================
        document.addEventListener('click', function (event) {
            const selectBodies = document.querySelectorAll('.admin-select-body');

            for (let i = 0; i < selectBodies.length; i++) {
                const selectBody = selectBodies[i];
                const selectDropdown = selectBody.querySelector('.admin-select-dropdown');
                if (event.target !== selectBody && !selectBody.contains(event.target)) {
        ...
        document.addEventListener('DOMContentLoaded', function () {
            var inputs = document.querySelectorAll('.verification-form input[type="number"]');
            ...
            inputs.forEach(function (input, index) {
                ...
                input.addEventListener('keydown', function (event) {
                    var key = event.key;
                    if (key === 'Backspace' && this.value.length === 0 && index > 0) {
                        inputs[index - 1].focus();
                    }
                });
            });
